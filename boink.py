...
def print_banner():
    ...
    print(f"{BOLD}{YELLOW}              MRPTech{RESET}")
    print(f"{BOLD}{RED}              Join Telegram Channel{RESET}")
    print(f"{CYAN}{'='*60}{RESET}")
...
def print_menu():
    ...
    print(f"{BOLD}{WHITE}  [3] EXIT{RESET}")
    print(f"{GREEN}{'-'*60}{RESET}")
    print()
